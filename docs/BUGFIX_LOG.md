...
- 修改文件：`src/render/sanitize.ts`、`src/render/sanitize.test.ts`、`docs/rendering-layers.md`、`docs/tasks/active/child-combinator-serialization.md`。
...
- 关联：`docs/tasks/active/child-combinator-serialization.md`。
...
- 修改文件：`src/render/sanitize.ts`、`src/render/sanitize.test.ts`、`docs/rendering-layers.md`、`docs/tasks/active/selector-pseudo-state-compat.md`。
...
- 关联：C-14、`docs/tasks/active/selector-pseudo-state-compat.md`。
...
- 修改文件：`src/render/paginator.ts`、`src/render/paginator.test.ts`、`docs/tasks/active/selector-pseudo-state-compat.md`。
...
- 关联：`docs/tasks/active/selector-pseudo-state-compat.md`。
...
- 修改文件：`src/render/sanitize.ts`、`src/render/sanitize.test.ts`、`docs/tasks/active/selector-pseudo-state-compat.md`。
...
- 修改文件：`src/render/paginator.ts`、`src/render/paginator.test.ts`、`docs/rendering-layers.md`、`docs/tasks/active/percent-margin-fit-content-layout.md`。
...
- 关联：C-16、`docs/tasks/active/percent-margin-fit-content-layout.md`。
...
- 修改文件：`src/render/sanitize.ts`、`src/render/sanitize.test.ts`、`src/render/paginator.test.ts`、`docs/rendering-layers.md`、`docs/tasks/active/svg-image-and-hr-layout.md`。
...
- 关联：C-17、`docs/tasks/active/svg-image-and-hr-layout.md`。
...
- 修改文件：`src/render/paginator.ts`、`src/render/paginator.test.ts`、`docs/rendering-layers.md`、`docs/tasks/active/fit-content-symmetric-margin-layout.md`。
...
- 关联：C-18、`docs/tasks/active/fit-content-symmetric-margin-layout.md`。
...
- 修改文件：`src/render/displayGate.ts`、`src/render/displayGate.test.ts`、`src/render/paginator.ts`、`docs/PRELOAD_PLAN.md`、`docs/PROJECT_CONTEXT.md`、`docs/MODULE_CONTRACTS.md`、`docs/rendering-layers.md`、`docs/tasks/active/initial-render-visibility-gate.md`。
...
- 关联：C-19、`docs/PRELOAD_PLAN.md`、`docs/tasks/active/initial-render-visibility-gate.md`。
...
- 修改文件：`src/ui/turnIntent.ts`、`src/ui/turnIntent.test.ts`、`src/ui/ReaderView.tsx`、`src/render/paginator.ts`、`docs/PROJECT_CONTEXT.md`、`docs/MODULE_CONTRACTS.md`、`docs/PRELOAD_PLAN.md`、`docs/rendering-layers.md`、`docs/tasks/active/wheel-intent-during-hidden-render.md`。
...
- 关联：C-20、B-015、`docs/tasks/active/wheel-intent-during-hidden-render.md`。
...
- 修改文件：`src/render/sanitize.ts`、`src/render/sanitize.test.ts`、`docs/MODULE_CONTRACTS.md`、`docs/rendering-layers.md`、`docs/tasks/active/toc-overflow-and-dashed-border.md`。
...
- 关联：C-05、C-21、`docs/tasks/active/toc-overflow-and-dashed-border.md`。
...
- 关联：C-22、B-011、`docs/tasks/active/toc-overflow-and-dashed-border.md`。
...
- 修改文件：`src/render/paginator.ts`、`src/render/paginator.test.ts`、`docs/rendering-layers.md`、`docs/tasks/active/media-only-float-avatar.md`。
...
- 关联：C-08、C-23、`docs/tasks/active/media-only-float-avatar.md`。
