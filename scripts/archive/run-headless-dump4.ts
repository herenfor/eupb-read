...
const server = http.createServer((req, res) => {
  const p = req.url === "/book.b64" ? "/home/herenfor/test/hltest/book.b64"
    : req.url === "/dump4.js" ? "/home/herenfor/test/hltest/dump4.js"
    : "/home/herenfor/test/hltest/dump4.html";
  try {
...
await new Promise<void>((r) => server.listen(8095, "127.0.0.1", r));
const browser = await chromium.launch({ headless: true });
const page = await browser.newPage();
await page.goto("http://127.0.0.1:8095/dump4.html");
