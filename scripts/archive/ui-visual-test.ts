...
await page.screenshot({ path: "<PROJECT_ROOT>/hltest/ui-1.png" });
const m1 = await measure();

await page.click('button[title="界面放大"]');
await page.click('button[title="界面放大"]');
await page.waitForTimeout(500);
await page.screenshot({ path: "<PROJECT_ROOT>/hltest/ui-2.png" });
const m2 = await measure();

await page.click('button[title="正文放大"]');
await page.click('button[title="正文放大"]');
await page.waitForTimeout(1500);
await page.screenshot({ path: "<PROJECT_ROOT>/hltest/ui-3.png" });
