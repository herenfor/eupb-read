...
const server = http.createServer((req, res) => {
  const p = req.url === "/book.b64" ? "/home/herenfor/test/hltest/book.b64"
    : req.url === "/hit.js" ? "/home/herenfor/test/hltest/hit.js"
    : req.url === "/dejavu.ttf" ? "/home/herenfor/test/hltest/dejavu.ttf"
    : "/home/herenfor/test/hltest/hit.html";
  try {
...
await new Promise<void>((r) => server.listen(8085, "127.0.0.1", r));
const browser = await chromium.launch({ headless: true });
const page = await browser.newPage();
page.on("console", (m) => console.log("[page]", m.text()));
await page.goto("http://127.0.0.1:8085/hit.html");
